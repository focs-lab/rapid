...
public class LockSetOfflineEngine extends RaceDetectionEngine<LockSetState, LockSetEvent> {
	
	private HashMap<String, HashSet<String>> variableToThreadSet;
	private HashMap<String, HashSet<String>> lockToThreadSet;

	
	public LockSetOfflineEngine(ParserType pType, String trace_folder, int verbosity) {
		super(pType);
