...
import engine.racedetectionengine.OSR_witness.POBuild.PartialOrder;
...
public class OSRState extends State {
    ...
    public HashMap<Integer, Long> recentWriteEvent; // varId -> [auxId]
    ...
    // 9. witness
    public boolean verifyWitness;
    public ArrayList<EventInfo>[] eventInfo;
    public ArrayList<EventInfo> auxIdToEvents;
    ...
    private void initInternalData(int numThreads, Map<Integer, Map<Integer, ArrayList<Integer>>> succFromNode,
        ...
        // part.2
        this.recentWriteEvent = new HashMap<>();
        ...
        // part.9
        this.verifyWitness = true;
        this.eventInfo = new ArrayList[this.numThreads];
        for(int i=0; i<numThreads; i++){
            this.eventInfo[i] = new ArrayList<>();
        }
        this.auxIdToEvents = new ArrayList<>();
    }
