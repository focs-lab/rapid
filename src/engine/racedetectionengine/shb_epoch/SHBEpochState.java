...
public class SHBEpochState extends State {
	...
	public ArrayList<FullAdaptiveVC> writeVariable;
	
	//Book-keeping the last-write's location
	public ArrayList<Integer> lastWriteVariableLocId;

	public SHBEpochState(HashSet<Thread> tSet) {
	...
	public void initData(HashSet<Thread> tSet) {
		...
		this.writeVariable = new ArrayList<FullAdaptiveVC>();
	...
	private int checkAndAddVariable(Variable v){
		if(!variableToIndex.containsKey(v)){
			...
			writeVariable			.add(new FullAdaptiveVC());
