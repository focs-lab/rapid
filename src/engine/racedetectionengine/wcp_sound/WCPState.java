...
//	public HashMap<Lock, HashMap<Long, VectorClock>> lastReleaseLockWriteVariable;
	...
	public void initData(HashSet<Thread> tSet) {
		...
		// this.lastReleaseLockReadVariable = new HashMap<Lock, HashMap<Variable,
		// VectorClock>>();
		// this.lastReleaseLockReadVariable = new HashMap<Lock, HashMap<Long,
		// VectorClock>>();
		...
		// this.lastReleaseLockWriteVariable = new HashMap<Lock, HashMap<Variable,
		// VectorClock>>();
		// this.lastReleaseLockWriteVariable = new HashMap<Lock, HashMap<Long,
		// VectorClock>>();
	...
	public void readViewOfWriters(Lock l, Thread t) {
		...
		local_vc_imax = view.getMaxLowerBound(t, l, P_t);
